...
async function createUser() {
    ...
    if (role === "employee" && !managerId) {
        message.style.color = "red";
        message.innerText = "Manager ID is required for employee creation";
        return;
    }
    ...
    try {
        const response = await fetch(`${API_BASE_URL}/hr/create-user`, {
            method: "POST",
            headers: {
...
function clearForm() {
    ...
    document.getElementById("managerId").style.display = "none";
}
